"""Quick test: P=150W, Q=10slm, V_reactor=250cm³, 4 temperatures."""
...
for T_K in EXP_DATA:
    ...
    SEI = P_W / (Q_SLM / 60.0)  # J/L
    print(f'T={T_K-273:3d}°C  CH4={conv:5.2f}%  (exp={EXP_DATA[T_K]:.2f}%)  '
          f'Te={Te_eV:.3f}eV  n_e={n_e:.2e}  tau={tau:.2f}s  t_end={t_end:.1f}s  '
          f'SEI={SEI:.0f}J/L')
