...
CONDITIONS = [
    ('Dry', 'Dry_Dg_10mm', '#4878a8'),
    ('Humid median', 'Humid_median_Dg_10mm', '#e8833a'),
    ('Humid fitting', 'Humid_fitting_Dg_10mm', '#9467bd'),
]
...
def main():
    ...
    fig.suptitle('Model vs Experiment — Voltage dependence (DIW, 10 min, δg=10mm)',
                 fontsize=14, y=1.01)
    fig.tight_layout()
